...
export default function LoginPage() {
    ...
    const handleNavigate = () => {
        navigate('/home'); // Navigates to the "/about" route
      };
    ...
    return (
      <div className="min-h-screen grid lg:grid-cols-2 px-3 md:px-0">
        ...
        {activeTab=='saas' ? <div className="space-y-3">
            <button onClick={handleNavigate} className="w-full flex items-center gap-2 px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors">
            <img
                src={gitHubLogo}
                alt="gitHub"
                width={20}
